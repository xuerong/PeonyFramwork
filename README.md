# 欢迎来到PeonyFramwork
<em>
我将在PeonyFramwork上践行这样一种架构思想：1、开发与部署分离；2、更智能的部署能力。 

“开发与部署分离”是指：在PeonyFramwork上进行业务的开发、调试不需要考虑他将如何部署，对开发者来讲，可以认为这就是一个单机服务，但是部署的时候，可以将他部署成单机，集群或者分布式系统，他将被如何部署对开发者来讲是无需感知的。对此，将制定一套规则，融合开发和部署能力。

“更智能的部署能力”是指：就像部署单机系统时，指定一个机器一样，部署PeonyFramwork，只需要指定一组机器，至于哪些服务会运行于哪些机器上，由PeonyFramwork根据历史情况，运行状态等决定，对于扩容，便是增加更多的机器，就像单机增加更多的内存一样。当然，一些场景也需要允许制定分配给特定服务的资源。对此，将构建一套“服务”与“资源”之间的关系模型，并制定一套基于历史和配置等信息，针对服务分配资源的规则。

这将要求制定一套规则，融合开发和部署能力，以及“服务”与“资源”之间的关系
