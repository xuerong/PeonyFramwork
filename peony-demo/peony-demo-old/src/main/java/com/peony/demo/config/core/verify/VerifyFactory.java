package com.peony.demo.config.core.verify;

import com.alibaba.fastjson.JSONArray;
import com.peony.demo.config.core.ConfigException;
import com.google.common.collect.Maps;
import com.peony.common.tool.helper.ClassUtil0;
...
public class VerifyFactory {
    ...
    static {
        List<Class<?>> classList = ClassUtil0.getClassList("com.peony.demo.config.core.verify.impl", true, IVerify.class, VerifyFactory.class.getClassLoader());
